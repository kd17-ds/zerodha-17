...
export default function Navbar() {
    let NavAdditional = document.getElementById("NavAdditionals");
    function displayEffect() {
        event.stopPropagation();
        NavAdditional.classList.toggle("hide");
        if (!NavAdditional.classList.contains("hide")) {
            window.addEventListener("click", hideNavAdditionalBox);
        }
    }
    function hideNavAdditionalBox() {
        NavAdditional.classList.add("hide");
    ...
    return (
        <nav className="navbar navbar-expand-lg ">
            ...
            <div id="NavAdditionals" className="Nav-Additionals">
